  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem, idx){
        return <div key={idx}>
          <Card company={elem.companyName} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} logo={elem.brandLogo} datepost={elem.datePosted} location={elem.location} />
        </div>
      })}
    </div>
  );
